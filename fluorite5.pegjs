    ...
    if (name === "classic") {
      ...
      return (function() {
        ...
        function VMStandard()
        {
            ...
            if (context === "get") {
              ...
              if (operator === "rightbracketsRound") {
                ...
                if (vm.instanceOf(value, vm.types.typeFunction)) {
                  ...
                  return vm.callMethod(value.value, ["method", "function"], [], vm.unpackVector(codes[1](vm, "get", [])));
                }
          ...
          this.toString = function(value) {
            ...
            if (vm.instanceOf(value, vm.types.typeValue)) {
              return "" + vm.callMethodOfBlessed(value, ["method", "function"], "toString", vm.VOID).value;
            } else {
              return "" + value;
            }
          };
          ...
          this.toBoolean = function(value) {
            vm.consumeLoopCapacity();
            if (vm.instanceOf(value, vm.types.typeValue)) {
              return !!vm.callMethodOfBlessed(value, ["method", "function"], "toBoolean", vm.VOID).value;
            } else {
              return !!value;
            }
          };
        ...
        VMStandard.prototype.initLibrary = function() {
          ...
          vm.scope.setOrDefine("_get_operatorPercent", vm.createFunctionNative([vm.types.typeValue, vm.types.typeNumber, vm.types.typeNumber], function(vm, blessedsArgs) {
            return vm.createObject(vm.types.typeNumber, blessedsArgs[1].value % blessedsArgs[2].value);
          }));
